...
import static android.opengl.EGL14.EGL_READ;
...
public abstract class GeneratedMovie implements Content {
    ...
    protected void prepareEncoder(String mimeType, int width, int height, int bitRate,
        ...
        Log.d(TAG,"prepareEncoder begin ,outfile="+outputFile.toString());
        ...
        EGLSurface currentSurface = EGL14.eglGetCurrentSurface(EGL_DRAW|EGL_READ);
        ...
        mTrackIndex = -1;
        mMuxerStarted = false;
        Log.d(TAG,"prepareEncoder end ,outfile="+outputFile.toString());
    }
