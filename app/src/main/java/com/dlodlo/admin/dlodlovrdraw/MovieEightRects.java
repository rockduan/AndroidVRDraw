...
public class MovieEightRects extends GeneratedMovie{
    ...
    public void create(File outputFile, ContentManager.ProgressUpdater prog) {
        ...
        try {
            ...
            Log.d(TAG,"MovieEightRects,prepareEncoder create frame begin ");
            for (int i = 0; i < NUM_FRAMES; i++) {
                ...
                generateFrame(i);
                long time = computePresentationTimeNsec(i);
                Log.d(TAG,"frame"+i+",PresentationTimeNsec"+time);
                submitFrame(time);

                prog.updateProgress(i * 100 / NUM_FRAMES);
            }
            Log.d(TAG,"MovieEightRects,prepareEncoder create frame end ");
    ...
    private void generateFrame(int frameIndex) {
        ...
        Log.d(TAG,"MovieEightRects,generateFrame,frameIndex="+frameIndex);
